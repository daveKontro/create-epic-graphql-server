...
// NOTE ⚠️ NO LONGER IN USE ⚠️
// as of v1.1.0 here for reference
      ...
      args: {
        name: {
          type: new GraphQLNonNull(new GraphQLEnumType({
            name: 'OrderName',
            values: {
              OrderNameOne: { value: OrderName.productOne },
              OrderNameTwo: { value: OrderName.productTwo },
              OrderNameThree: { value: OrderName.productThree },
            },
          })),
          defaultValue: null,
        },
        ...
        OrderStatus: {
          type: new GraphQLNonNull(new GraphQLEnumType({
            ...
            values: {
              notStarted: { value: OrderStatus.notStarted },
              processing: { value: OrderStatus.processing },
              sent: { value: OrderStatus.sent },
            },
          })),
          defaultValue: OrderStatus.notStarted,
        },
